...
/*
    ...
    const config = {
      birthdate: 'Feb 29, 2020', // Février
      name: 'Darlene'
    };

    const config = {
      birthdate: 'Mar 29, 2020', // Mars
      name: 'Darlene'
    };

    const config = {
      birthdate: 'Apr 29, 2020', // Avril
      name: 'Darlene'
    };

    const config = {
      birthdate: 'May 29, 2020', // Mai
      name: 'Darlene'
    };

    const config = {
      birthdate: 'Jun 29, 2020', // Juin
      name: 'Darlene'
    };

    const config = {
      birthdate: 'Jul 29, 2020', // Juillet
      name: 'Darlene'
    };

    const config = {
      birthdate: 'Aug 29, 2020', // Août
      name: 'Darlene'
    };

    const config = {
      birthdate: 'Sep 29, 2020', // Septembre
      name: 'Darlene'
    };

    const config = {
      birthdate: 'Oct 29, 2020', // Octobre
      name: 'Darlene'
    };

    const config = {
      birthdate: 'Nov 29, 2020', // Novembre
      name: 'Darlene'
    };

    const config = {
      birthdate: 'Dec 29, 2020', // Décembre
      name: 'Darlene'
    };
...
/*
let now = new Date();
now.setHours(12, 32, 0, 0);
let countDown = now.getTime();  // Le timestamp de 12h30 aujourd'hui
*/
